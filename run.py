...
if __name__ == '__main__':
    ...
    parser.add_argument('--learning_rate2', type=float, default=1e-3, help='mlp learning rate')
    parser.add_argument('--learning_rate3', type=float, default=1e-3, help='proj learning rate')
    parser.add_argument('--prompt_weight', type=float, default=0.1, help='prompt weight')#please tune this hyperparameter for combining
    ...
    parser.add_argument('--use_closedllm', type=int, default=1, help='use closedllm or not')    
    ...
    #WPMixer
    parser.add_argument('--device', type=str, default='0', help='device ids of multile gpus')
    parser.add_argument('--patch_len', type=int, default=16, help='patch length')


    parser.add_argument('--use_text', type=bool, default=True, help='use TICAL')
    parser.add_argument('--TICAL_k', type=int, default=4,help='kernel num')
    parser.add_argument('--TICAL_shape_types', type=int, default=4, help='kernel type num')
    parser.add_argument('--TICAL_kernel_emb_dim', type=int, default=64, help='kernel embedding num')
    parser.add_argument('--TICAL_cot_eps', type=float, default=0.1,help='kernel TICAL_cot_eps')
    parser.add_argument('--TICAL_cot_iters', type=int, default=50,help='kernel TICAL_cot_iters')
    parser.add_argument('--TICAL_cot_bandwidth', type=int, default=6,help='kernel TICAL_cot_bandwith')
    parser.add_argument('--TICAL_cot_alpha', type=float, default=1.0, help='COT cost weight (cosine part)')
    parser.add_argument('--TICAL_cot_beta', type=float, default=0.02, help='COT cost weight (early-match penalty)')
    parser.add_argument('--TICAL_lmb_cot', type=float, default=0.1, help='weight of COT loss')
    parser.add_argument('--TICAL_lmb_delta', type=float, default=0.05, help='weight of delta-contrastive loss')
    parser.add_argument('--TICAL_lmb_entropy', type=float, default=0.03, help='weight of entropy reg on shape_w')
    parser.add_argument('--TICAL_lmb_tv', type=float, default=0.02, help='weight of total variation reg on mu')
    parser.add_argument('--TICAL_kernel_H_scale', type=float, default=0.2, help='keinel_H_scale')
    parser.add_argument('--TICAL_gate_weight', type=float, default=0.01, help='gate fusion weight')
    parser.add_argument('--TICAL_gate_dim', type=int, default=128, help='gate dim')
    parser.add_argument('--loss_function', type=str, default='mae', help='loss function')
    parser.add_argument('--adjust_loss', type=float, default=0.1, help='adjust loss')
    parser.add_argument('--delta', type=float, default=0, help='delta weight')
    parser.add_argument('--random_weight', type=float, default=0, help='random weight')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_expand{}_dc{}_fc{}_eb{}_dt{}_{}_{}_te_{}_pw_{}_Tk{}_Ts{}_Ke{}_Ce{}_Ci{}_Cbw{}_Ca{}_Cb{}_Lc{}_Ld{}_Le{}_Lt{}_Gw{}_Gd{}_de{}_loss{}'.format(
                args.task_name,
                args.model_id,
                args.features,
                args.seq_len,
                ...
                args.text_emb,
                args.prior_weight,
                # 🔽 TICAL 参数缩写进 setting 名称
                args.TICAL_k,              # Tk
                args.TICAL_shape_types,    # Ts
                args.TICAL_kernel_emb_dim, # Ke
                args.TICAL_cot_eps,        # Ce
                args.TICAL_cot_iters,      # Ci
                args.TICAL_cot_bandwidth,  # Cbw
                args.TICAL_cot_alpha,      # Ca
                args.TICAL_cot_beta,       # Cb
                args.TICAL_lmb_cot,        # Lc
                args.TICAL_lmb_delta,      # Ld
                args.TICAL_lmb_entropy,    # Le
                args.TICAL_lmb_tv,         # Lt
                args.TICAL_gate_weight,    # Gw
                args.TICAL_gate_dim,        # Gd
                args.delta,
                args.loss_function)
        ...
        ii = 0
        setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_expand{}_dc{}_fc{}_eb{}_dt{}_{}_{}_te_{}_pw_{}_Tk{}_Ts{}_Ke{}_Ce{}_Ci{}_Cbw{}_Ca{}_Cb{}_Lc{}_Ld{}_Le{}_Lt{}_Gw{}_Gd{}__de{}_loss{}'.format(
            args.task_name,
            args.model_id,
            args.features,
            args.seq_len,
