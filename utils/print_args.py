def print_args(args):
    ...
    print(f'  {"Use Text (TICAL):":<20}{args.use_text:<20}{"TICAL_k:":<20}{args.TICAL_k:<20}')
    print(f'  {"TICAL Shape Types:":<20}{args.TICAL_shape_types:<20}{"TICAL Kernel Emb Dim:":<20}{args.TICAL_kernel_emb_dim:<20}')
    print(f'  {"TICAL COT Eps:":<20}{args.TICAL_cot_eps:<20}{"TICAL COT Iters:":<20}{args.TICAL_cot_iters:<20}')
    print(f'  {"TICAL COT Bandwidth:":<20}{args.TICAL_cot_bandwidth:<20}{"TICAL COT Alpha:":<20}{args.TICAL_cot_alpha:<20}')
    print(f'  {"TICAL COT Beta:":<20}{args.TICAL_cot_beta:<20}{"TICAL LMB COT:":<20}{args.TICAL_lmb_cot:<20}')
    print(f'  {"TICAL LMB Delta:":<20}{args.TICAL_lmb_delta:<20}{"TICAL LMB Entropy:":<20}{args.TICAL_lmb_entropy:<20}')
    print(f'  {"TICAL LMB TV:":<20}{args.TICAL_lmb_tv:<20}{"TICAL Kernel H Scale:":<20}{args.TICAL_kernel_H_scale:<20}')
    print(f'  {"TICAL Gate Weight:":<20}{args.TICAL_gate_weight:<20}{"TICAL Gate Dim:":<20}{args.TICAL_gate_dim:<20}')
    print()
